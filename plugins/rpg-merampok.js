...
let dapat = (Math.floor(Math.random() * 100000000))
  ...
  let nyolong = global.db.data.users
 if (who.includes("628988293493")) {
m.reply("Kamu merampok owner bot, kamu di denda 500 Juta awoakwok mampus")
 nyolong[m.sender].money -= 500000000 // dapat * 1
} else {
  ...
  users[who].money -= 80128896 // dapat * 1
  users[m.sender].money += 80128896 // dapat * 1
